...
const sampleEvent = {
  ...
  description: 'A spectacular outdoor music festival featuring top artists from around the world. Enjoy live performances, food stalls, and amazing vibes.',
  category: 'Music',
  date: '2026-07-15',
  time: '14:00',
...
export default function EditEvent() {
  ...
  const onSubmit = (data) => {
    console.log('Event updated:', { ...data, image });
  };
